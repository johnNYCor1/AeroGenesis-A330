...
function A333_fws_global_variable_assignment()
    ...
    EEPWRCON        = ternary(simDR_gpu_on == 1, true, false)
    EGN1COF         = ternary(A333_buttons_gen1_pos == 0, true, false)
    EGN2COF         = ternary(A333_buttons_gen2_pos == 0, true, false)
    ...
    HBSLP           = ternary(simDR_blue_hydraulic_pressure < 1450.0, true, false)
    ...
    HGSLP           = ternary(simDR_green_hydraulic_pressure < 1450.0, true, false)
    ...
    HYSLP           = ternary(simDR_yellow_hydraulic_pressure < 1450.0, true, false)
